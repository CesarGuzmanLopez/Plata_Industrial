	...
	<editor name="{{$name}}" id="{{$id}}" value='{!! $value??(old($name)??"")  !!}'   class="border" placeholder="Ingresa {{$name}}"    api-key='y384aesqbqgvxfvpzzc4i6h5sujdgwsxf4gf7uajcr2o2tkv' pla :init="{ 
                    ...
                    mathjax: {
                  	...
                  	menubar: 'edit insert code view format table toc tools wordcount insert ' ,
				       toolbar: 'forecolor backcolor code charmap visualblocks insert hr tabfocus toc media numlist bullist importcss emoticons  mathjax  tiny_mce_wiris_formulaEditorChemistry',
                  	plugins: 'table image  code visualblocks codesample advlist directionality  tabfocus media lists imagetools  emoticons autolink  charmap template wordcount  mathjax  autoresize hr',
                  	branding: false,
           		   entity_encoding : 'raw',
